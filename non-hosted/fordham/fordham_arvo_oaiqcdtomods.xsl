...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="oai_qdc:qualifieddc">
    <mods xmlns="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
      ...
      <xsl:element name="physicalDescription" namespace="http://www.loc.gov/mods/v3">
        <xsl:apply-templates select="dcterms:extent[1]"/>
      </xsl:element>
      ...
      <xsl:apply-templates select="dcterms:tableOfContents" mode="fordham"/>
      ...
      <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
        ...
        <xsl:element name="titleInfo" namespace="http://www.loc.gov/mods/v3">
          <xsl:element name="title" namespace="http://www.loc.gov/mods/v3">Fordham University-Arvo Pärt: Sounding the Sacred</xsl:element>
        </xsl:element>
      </xsl:element>
  ...
  <xsl:template match="dcterms:tableOfContents" mode="fordham">

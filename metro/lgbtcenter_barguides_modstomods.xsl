    ...
    <xsl:template match="mods:mods">
        <xsl:copy>
            ...
            <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
                ...
                <xsl:element name="abstract" namespace="http://www.loc.gov/mods/v3">This collection consists of three New York City Gay Guides held by the Lesbian Gay Bisexual and Transgender Community Center National History Archive. The collection is important in reflecting the history of LGBT groups in NYC. This collection features two of the earliest guides for the city, from the late 1960s, as well as one from the late 80s.</xsl:element>
            </xsl:element>
        </xsl:copy>
    </xsl:template>

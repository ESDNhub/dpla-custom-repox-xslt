...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mods:mods">
        <xsl:copy>
            ...
            <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
                ...
                <xsl:element name="abstract" namespace="http://www.loc.gov/mods/v3">The Hall of Fame for Great Americans collection consists of 143 photographs and documents related to the selection, election, induction and media coverage of individuals represented in the Hall of Fame located at Bronx Community College (BCC).</xsl:element>
            </xsl:element>
        </xsl:copy>
    </xsl:template>
    ...
    <xsl:template match="mods:roleTerm">
        <xsl:element name="roleTerm" namespace="http://www.loc.gov/mods/v3">
            <xsl:choose>
                <xsl:when test="normalize-space(lower-case(.))='sculptor'">creator</xsl:when>
                <xsl:otherwise>

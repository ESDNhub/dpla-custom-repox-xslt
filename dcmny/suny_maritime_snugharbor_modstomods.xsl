    ...
    <xsl:template match="mods:mods">
        <xsl:copy>
            ...
            <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
                ...
                <xsl:element name="abstract" namespace="http://www.loc.gov/mods/v3">Sailors’ Snug Harbor was the first maritime home and hospital for retired sailors in the United States, founded in 1801 and located on Staten Island for over 140 years. The Sailors’ Snug Harbor Inmate Records consists of approximately 1500 photographic portraits and 1500 register pages (circa 1870s-1920s) documenting the lives of residents before and during their stay at the institution.</xsl:element>
            </xsl:element>
        </xsl:copy>
    </xsl:template>

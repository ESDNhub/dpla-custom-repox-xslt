    ...
    <xsl:template match="mods:mods">
        <xsl:copy>
            ...
            <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
                ...
                <xsl:element name="abstract" namespace="http://www.loc.gov/mods/v3">This collection features 86 issues of The Center Publications ‘The Center Voice’ and ‘Center Happenings’ held by the Lesbian Gay Bisexual and Transgender Community Center National History Archive. The collection is important in reflecting the history of LGBT groups in New York City.</xsl:element>
            </xsl:element>
        </xsl:copy>
    </xsl:template>

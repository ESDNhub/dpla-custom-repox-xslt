...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mods:mods">
        <xsl:copy>
            ...
            <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
                ...
                <xsl:element name="abstract" namespace="http://www.loc.gov/mods/v3">Established in 1785, The General Society of Mechanics and Tradesmen (GSMT) is a non-profit organization serving the people of the City of New York for over two centuries, through educational, cultural and philanthropic programs. The 364 objects in the Industry and Culture Collection highlight items of institutional, metropolitan and national history held in the Society’s archival and museum collections.</xsl:element>
            </xsl:element>
        </xsl:copy>
    </xsl:template>
    ...
    <xsl:template match="mods:dateCreated[contains(lower-case(./text()), 'undated')]"/>

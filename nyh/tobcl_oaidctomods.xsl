    ...
    <mods xmlns="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-4.xsd" version="3.4">
      ...
      <xsl:apply-templates select="dc:contributor"/>
        ...
        <originInfo>
          <xsl:for-each select="dc:date">
            <xsl:if test="normalize-space(./text())!='9999' and lower-case(normalize-space(./text()))!='unknown'">
      ...
      <xsl:element name="relatedItem" namespace="http://www.loc.gov/mods/v3">
        ...
        <xsl:element name="titleInfo" namespace="http://www.loc.gov/mods/v3">
          <xsl:element name="title" namespace="http://www.loc.gov/mods/v3">Town of Ballston Community Library</xsl:element>
        </xsl:element>
      </xsl:element>
      ...
      <xsl:call-template name="intermediate-provider"><xsl:with-param name="council">Capital District Library Council</xsl:with-param></xsl:call-template><xsl:call-template name="owner-note">
        <xsl:with-param name="owner">Town of Ballston Community Library</xsl:with-param>
      </xsl:call-template>
